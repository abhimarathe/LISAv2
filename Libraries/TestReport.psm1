...
Class TestSummary
{
	...
	{
		if ( $this.AddHeader ) {
			$this.TextSummary += "{0,5} {1,-20} {2,-65} {3,20} {4,20} `r`n" -f "ID", "TestArea", "TestCaseName-SetupHashCode", "TestResult", "TestDuration(in minutes)"
